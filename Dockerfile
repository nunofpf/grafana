...
RUN git clone https://github.com/criticalmanufacturing/grafana-odata-datasource.git /go/src/odata -b feature-odata-query-string/11.2/7/privatefix/plessey  --depth 1
...
RUN git clone https://github.com/criticalmanufacturing/grafana-odata-datasource.git /usr/src/odata -b feature-odata-query-string/11.2/7/privatefix/plessey  --depth 1
